...
namespace DJTUStudentSystem.DBSession
{
    ...
    {
        public static DbSession Context2 = new DbSession(DatabaseType.SqlServer9, @"Data Source=.;Database=Education;User Id=sa;Password=52Xuguoxu;");//笔记本
        ...
        public static Dictionary<string, object> ExecuteProc(string Procname, IList<Procparameters> Inparameters, IList<Procparameters> Outparameters)
        {
            ...
            ProcSection proc = Context.FromProc("Proc");
