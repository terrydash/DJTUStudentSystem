...
namespace DJTUStudentSystem.DataBaseModel
{
    ...
    {
        public Vw_TeachClass() : base("vw_TeachClass") { }
        ...
        public override void SetPropertyValues(IDataReader reader)
        {
            ...
            this._编码 = DataUtils.ConvertValue<string>(reader["编码"]);
            ...
            this._预计数量 = DataUtils.ConvertValue<int?>(reader["预计数量"]);
            this._RGName = DataUtils.ConvertValue<string>(reader["RGName"]);
            this._CTID = DataUtils.ConvertValue<int?>(reader["CTID"]);
            this._StartA = DataUtils.ConvertValue<int?>(reader["StartA"]);
            this._EndA = DataUtils.ConvertValue<int?>(reader["EndA"]);
            this._PerWeekA = DataUtils.ConvertValue<int?>(reader["PerWeekA"]);
            this._StartB = DataUtils.ConvertValue<string>(reader["StartB"]);
            this._EndB = DataUtils.ConvertValue<string>(reader["EndB"]);
            this._PerWeekB = DataUtils.ConvertValue<string>(reader["PerWeekB"]);
            ...
            this._助课教师 = DataUtils.ConvertValue<string>(reader["助课教师"]);
            this._StandCode2 = DataUtils.ConvertValue<string>(reader["StandCode2"]);
            this._教师3 = DataUtils.ConvertValue<string>(reader["教师3"]);
            this._StandCode3 = DataUtils.ConvertValue<string>(reader["StandCode3"]);
        ...
        public override void SetPropertyValues(DataRow row)
        {
            ...
            this._编码 = DataUtils.ConvertValue<string>(row["编码"]);
            ...
            this._预计数量 = DataUtils.ConvertValue<int?>(row["预计数量"]);
            this._RGName = DataUtils.ConvertValue<string>(row["RGName"]);
            this._CTID = DataUtils.ConvertValue<int?>(row["CTID"]);
            this._StartA = DataUtils.ConvertValue<int?>(row["StartA"]);
            this._EndA = DataUtils.ConvertValue<int?>(row["EndA"]);
            this._PerWeekA = DataUtils.ConvertValue<int?>(row["PerWeekA"]);
            this._StartB = DataUtils.ConvertValue<string>(row["StartB"]);
            this._EndB = DataUtils.ConvertValue<string>(row["EndB"]);
            this._PerWeekB = DataUtils.ConvertValue<string>(row["PerWeekB"]);
            ...
            this._助课教师 = DataUtils.ConvertValue<string>(row["助课教师"]);
            this._StandCode2 = DataUtils.ConvertValue<string>(row["StandCode2"]);
            this._教师3 = DataUtils.ConvertValue<string>(row["教师3"]);
            this._StandCode3 = DataUtils.ConvertValue<string>(row["StandCode3"]);
