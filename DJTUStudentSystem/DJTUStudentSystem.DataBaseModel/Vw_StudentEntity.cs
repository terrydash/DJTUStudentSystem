...
namespace DJTUStudentSystem.DataBaseModel
{
    ...
    {
        public Vw_Student() : base("vw_Student") { }
        ...
        public override void SetPropertyValues(IDataReader reader)
        {
            ...
            this._小学号 = DataUtils.ConvertValue<int?>(reader["小学号"]);
            this._系部 = DataUtils.ConvertValue<string>(reader["系部"]);
            this._专业 = DataUtils.ConvertValue<string>(reader["专业"]);
            this._年级 = DataUtils.ConvertValue<string>(reader["年级"]);
            this._班级 = DataUtils.ConvertValue<string>(reader["班级"]);
            this._学生姓名 = DataUtils.ConvertValue<string>(reader["学生姓名"]);
            this._曾用名 = DataUtils.ConvertValue<string>(reader["曾用名"]);
            this._性别 = DataUtils.ConvertValue<string>(reader["性别"]);
            this._出生年月日 = DataUtils.ConvertValue<string>(reader["出生年月日"]);
            this._政治面貌 = DataUtils.ConvertValue<string>(reader["政治面貌"]);
            this._民族 = DataUtils.ConvertValue<string>(reader["民族"]);
            this._毕业学校 = DataUtils.ConvertValue<string>(reader["毕业学校"]);
            this._生源 = DataUtils.ConvertValue<string>(reader["生源"]);
            this._籍贯 = DataUtils.ConvertValue<string>(reader["籍贯"]);
            this._家庭住址 = DataUtils.ConvertValue<string>(reader["家庭住址"]);
            this._家庭电话 = DataUtils.ConvertValue<string>(reader["家庭电话"]);
            this._邮政编码 = DataUtils.ConvertValue<string>(reader["邮政编码"]);
            this._入学方式 = DataUtils.ConvertValue<string>(reader["入学方式"]);
            this._父亲姓名 = DataUtils.ConvertValue<string>(reader["父亲姓名"]);
            this._母亲姓名 = DataUtils.ConvertValue<string>(reader["母亲姓名"]);
            this._父亲单位 = DataUtils.ConvertValue<string>(reader["父亲单位"]);
            this._父亲职务 = DataUtils.ConvertValue<string>(reader["父亲职务"]);
            this._母亲单位 = DataUtils.ConvertValue<string>(reader["母亲单位"]);
            this._母亲职务 = DataUtils.ConvertValue<string>(reader["母亲职务"]);
            this._身高 = DataUtils.ConvertValue<decimal?>(reader["身高"]);
            this._体重 = DataUtils.ConvertValue<decimal?>(reader["体重"]);
            this._职务 = DataUtils.ConvertValue<string>(reader["职务"]);
            this._特长 = DataUtils.ConvertValue<string>(reader["特长"]);
            this._宿舍号 = DataUtils.ConvertValue<string>(reader["宿舍号"]);
            this._宿舍电话 = DataUtils.ConvertValue<string>(reader["宿舍电话"]);
            this._备注 = DataUtils.ConvertValue<string>(reader["备注"]);
            this._StdID = DataUtils.ConvertValue<int>(reader["StdID"]);
            ...
            this._外语语种 = DataUtils.ConvertValue<string>(reader["外语语种"]);
            this._身份证号码 = DataUtils.ConvertValue<string>(reader["身份证号码"]);
            this._N = DataUtils.ConvertValue<string>(reader["n"]);
            this._Y = DataUtils.ConvertValue<string>(reader["y"]);
            this._R = DataUtils.ConvertValue<string>(reader["r"]);
            ...
            this._Biye = DataUtils.ConvertValue<string>(reader["Biye"]);
            this._Xuewei = DataUtils.ConvertValue<string>(reader["Xuewei"]);
            this._KSH = DataUtils.ConvertValue<string>(reader["KSH"]);
            this._RGName = DataUtils.ConvertValue<string>(reader["RGName"]);
            this._Mark = DataUtils.ConvertValue<string>(reader["Mark"]);
            this._Xxstate = DataUtils.ConvertValue<string>(reader["xxstate"]);
            ...
            this._CX12 = DataUtils.ConvertValue<int?>(reader["CX12"]);
            this._BJGNum = DataUtils.ConvertValue<int?>(reader["BJGNum"]);
            this._Lost = DataUtils.ConvertValue<int?>(reader["Lost"]);
            this._LastNum = DataUtils.ConvertValue<int?>(reader["LastNum"]);
            this._LastTime = DataUtils.ConvertValue<DateTime?>(reader["LastTime"]);
            this._BYSJ = DataUtils.ConvertValue<string>(reader["BYSJ"]);
            this._Bank = DataUtils.ConvertValue<string>(reader["Bank"]);
            this._CurTerm = DataUtils.ConvertValue<int?>(reader["CurTerm"]);
            this._Email = DataUtils.ConvertValue<string>(reader["Email"]);
            this._EnglishLev = DataUtils.ConvertValue<string>(reader["EnglishLev"]);
            this._EndlishSource = DataUtils.ConvertValue<double?>(reader["EndlishSource"]);
            this._Engname = DataUtils.ConvertValue<string>(reader["Engname"]);
            this._Photo = DataUtils.ConvertValue<string>(reader["Photo"]);
            this._SelfPlan = DataUtils.ConvertValue<string>(reader["SelfPlan"]);
            this._层次 = DataUtils.ConvertValue<string>(reader["层次"]);
            this._VGroup = DataUtils.ConvertValue<string>(reader["vGroup"]);
        }
        /// <summary>
        /// 给当前实体赋值
        /// </summary>
        public override void SetPropertyValues(DataRow row)
        {
            ...
            this._小学号 = DataUtils.ConvertValue<int?>(row["小学号"]);
            this._系部 = DataUtils.ConvertValue<string>(row["系部"]);
            this._专业 = DataUtils.ConvertValue<string>(row["专业"]);
            this._年级 = DataUtils.ConvertValue<string>(row["年级"]);
            this._班级 = DataUtils.ConvertValue<string>(row["班级"]);
            this._学生姓名 = DataUtils.ConvertValue<string>(row["学生姓名"]);
            this._曾用名 = DataUtils.ConvertValue<string>(row["曾用名"]);
            this._性别 = DataUtils.ConvertValue<string>(row["性别"]);
            this._出生年月日 = DataUtils.ConvertValue<string>(row["出生年月日"]);
            this._政治面貌 = DataUtils.ConvertValue<string>(row["政治面貌"]);
            this._民族 = DataUtils.ConvertValue<string>(row["民族"]);
            this._毕业学校 = DataUtils.ConvertValue<string>(row["毕业学校"]);
            this._生源 = DataUtils.ConvertValue<string>(row["生源"]);
            this._籍贯 = DataUtils.ConvertValue<string>(row["籍贯"]);
            this._家庭住址 = DataUtils.ConvertValue<string>(row["家庭住址"]);
            this._家庭电话 = DataUtils.ConvertValue<string>(row["家庭电话"]);
            this._邮政编码 = DataUtils.ConvertValue<string>(row["邮政编码"]);
            this._入学方式 = DataUtils.ConvertValue<string>(row["入学方式"]);
            this._父亲姓名 = DataUtils.ConvertValue<string>(row["父亲姓名"]);
            this._母亲姓名 = DataUtils.ConvertValue<string>(row["母亲姓名"]);
            this._父亲单位 = DataUtils.ConvertValue<string>(row["父亲单位"]);
            this._父亲职务 = DataUtils.ConvertValue<string>(row["父亲职务"]);
            this._母亲单位 = DataUtils.ConvertValue<string>(row["母亲单位"]);
            this._母亲职务 = DataUtils.ConvertValue<string>(row["母亲职务"]);
            this._身高 = DataUtils.ConvertValue<decimal?>(row["身高"]);
            this._体重 = DataUtils.ConvertValue<decimal?>(row["体重"]);
            this._职务 = DataUtils.ConvertValue<string>(row["职务"]);
            this._特长 = DataUtils.ConvertValue<string>(row["特长"]);
            this._宿舍号 = DataUtils.ConvertValue<string>(row["宿舍号"]);
            this._宿舍电话 = DataUtils.ConvertValue<string>(row["宿舍电话"]);
            this._备注 = DataUtils.ConvertValue<string>(row["备注"]);
            this._StdID = DataUtils.ConvertValue<int>(row["StdID"]);
            ...
            this._外语语种 = DataUtils.ConvertValue<string>(row["外语语种"]);
            this._身份证号码 = DataUtils.ConvertValue<string>(row["身份证号码"]);
            this._N = DataUtils.ConvertValue<string>(row["n"]);
            this._Y = DataUtils.ConvertValue<string>(row["y"]);
            this._R = DataUtils.ConvertValue<string>(row["r"]);
            ...
            this._Biye = DataUtils.ConvertValue<string>(row["Biye"]);
            this._Xuewei = DataUtils.ConvertValue<string>(row["Xuewei"]);
            this._KSH = DataUtils.ConvertValue<string>(row["KSH"]);
            this._RGName = DataUtils.ConvertValue<string>(row["RGName"]);
            this._Mark = DataUtils.ConvertValue<string>(row["Mark"]);
            this._Xxstate = DataUtils.ConvertValue<string>(row["xxstate"]);
            ...
            this._CX12 = DataUtils.ConvertValue<int?>(row["CX12"]);
            this._BJGNum = DataUtils.ConvertValue<int?>(row["BJGNum"]);
            this._Lost = DataUtils.ConvertValue<int?>(row["Lost"]);
            this._LastNum = DataUtils.ConvertValue<int?>(row["LastNum"]);
            this._LastTime = DataUtils.ConvertValue<DateTime?>(row["LastTime"]);
            this._BYSJ = DataUtils.ConvertValue<string>(row["BYSJ"]);
            this._Bank = DataUtils.ConvertValue<string>(row["Bank"]);
            this._CurTerm = DataUtils.ConvertValue<int?>(row["CurTerm"]);
            this._Email = DataUtils.ConvertValue<string>(row["Email"]);
            this._EnglishLev = DataUtils.ConvertValue<string>(row["EnglishLev"]);
            this._EndlishSource = DataUtils.ConvertValue<double?>(row["EndlishSource"]);
            this._Engname = DataUtils.ConvertValue<string>(row["Engname"]);
            this._Photo = DataUtils.ConvertValue<string>(row["Photo"]);
            this._SelfPlan = DataUtils.ConvertValue<string>(row["SelfPlan"]);
            this._层次 = DataUtils.ConvertValue<string>(row["层次"]);
            this._VGroup = DataUtils.ConvertValue<string>(row["vGroup"]);
        }
        #endregion
