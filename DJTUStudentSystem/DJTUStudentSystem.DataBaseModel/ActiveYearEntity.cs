...
namespace DJTUStudentSystem.DataBaseModel
{
    ...
    public partial class Activeyear : Entity
    {
        ...
        public override void SetPropertyValues(IDataReader reader)
        {
            ...
            this._XKstate = DataUtils.ConvertValue<string>(reader["XKstate"]);
            this._PKstate = DataUtils.ConvertValue<string>(reader["PKstate"]);
            this._Regstate = DataUtils.ConvertValue<string>(reader["Regstate"]);
            ...
            this._Weeks = DataUtils.ConvertValue<int?>(reader["Weeks"]);
            this._Process = DataUtils.ConvertValue<string>(reader["Process"]);
            this._Appstate = DataUtils.ConvertValue<string>(reader["Appstate"]);
            this._RsState = DataUtils.ConvertValue<string>(reader["RsState"]);
            this._CJState = DataUtils.ConvertValue<string>(reader["CJState"]);
        }
        /// <summary>
        /// 给当前实体赋值
        /// </summary>
        public override void SetPropertyValues(DataRow row)
        {
            ...
            this._XKstate = DataUtils.ConvertValue<string>(row["XKstate"]);
            this._PKstate = DataUtils.ConvertValue<string>(row["PKstate"]);
            this._Regstate = DataUtils.ConvertValue<string>(row["Regstate"]);
            this._Startdate = DataUtils.ConvertValue<DateTime?>(row["Startdate"]);
            this._Enddate = DataUtils.ConvertValue<DateTime?>(row["Enddate"]);
            this._Weeks = DataUtils.ConvertValue<int?>(row["Weeks"]);
            this._Process = DataUtils.ConvertValue<string>(row["Process"]);
            this._Appstate = DataUtils.ConvertValue<string>(row["Appstate"]);
            this._RsState = DataUtils.ConvertValue<string>(row["RsState"]);
            this._CJState = DataUtils.ConvertValue<string>(row["CJState"]);
        }
        #endregion
