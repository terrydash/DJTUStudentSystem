...
namespace DJTUStudentSystem.DataBaseModel
{
    ...
    {
        public Curricula() : base("Curricula") { }
        ...
        public override void SetPropertyValues(IDataReader reader)
        {
            ...
            this._CPyCode = DataUtils.ConvertValue<string>(reader["CPyCode"]);
            this._CCname = DataUtils.ConvertValue<string>(reader["CCname"]);
            ...
            this._MaxNum = DataUtils.ConvertValue<int?>(reader["MaxNum"]);
            this._Source = DataUtils.ConvertValue<decimal?>(reader["Source"]);
            this._Period = DataUtils.ConvertValue<decimal?>(reader["Period"]);
            this._Prelect = DataUtils.ConvertValue<int?>(reader["Prelect"]);
            this._Experiment = DataUtils.ConvertValue<int?>(reader["Experiment"]);
            this._OnComputer = DataUtils.ConvertValue<int?>(reader["OnComputer"]);
            this._Other = DataUtils.ConvertValue<decimal?>(reader["Other"]);
            this._Examsort = DataUtils.ConvertValue<string>(reader["Examsort"]);
            this._Memo = DataUtils.ConvertValue<string>(reader["Memo"]);
            this._ClassNum = DataUtils.ConvertValue<short?>(reader["ClassNum"]);
            this._CLevel = DataUtils.ConvertValue<int?>(reader["CLevel"]);
            this._MMedia = DataUtils.ConvertValue<string>(reader["MMedia"]);
            this._RoomSort = DataUtils.ConvertValue<string>(reader["RoomSort"]);
            this._SelectMode = DataUtils.ConvertValue<string>(reader["SelectMode"]);
            this._NormalScale = DataUtils.ConvertValue<int?>(reader["NormalScale"]);
            this._ExpScale = DataUtils.ConvertValue<int?>(reader["ExpScale"]);
            this._ExamineScale = DataUtils.ConvertValue<int?>(reader["ExamineScale"]);
            this._StuNum = DataUtils.ConvertValue<int?>(reader["StuNum"]);
            this._UseDControl = DataUtils.ConvertValue<string>(reader["UseDControl"]);
            this._RsGroup = DataUtils.ConvertValue<string>(reader["RsGroup"]);
            this._IFPK = DataUtils.ConvertValue<string>(reader["IFPK"]);
            ...
            this._ModifyOper = DataUtils.ConvertValue<string>(reader["ModifyOper"]);
            this._ModifyDate = DataUtils.ConvertValue<DateTime?>(reader["ModifyDate"]);
            this._NewOper = DataUtils.ConvertValue<string>(reader["NewOper"]);
            this._NewDate = DataUtils.ConvertValue<DateTime?>(reader["NewDate"]);
            this._EachSection = DataUtils.ConvertValue<string>(reader["EachSection"]);
            this._OutLinenum = DataUtils.ConvertValue<int?>(reader["OutLinenum"]);
        }
        /// <summary>
        /// 给当前实体赋值
        /// </summary>
        public override void SetPropertyValues(DataRow row)
        {
            ...
            this._CPyCode = DataUtils.ConvertValue<string>(row["CPyCode"]);
            this._CCname = DataUtils.ConvertValue<string>(row["CCname"]);
            ...
            this._MaxNum = DataUtils.ConvertValue<int?>(row["MaxNum"]);
            this._Source = DataUtils.ConvertValue<decimal?>(row["Source"]);
            this._Period = DataUtils.ConvertValue<decimal?>(row["Period"]);
            this._Prelect = DataUtils.ConvertValue<int?>(row["Prelect"]);
            this._Experiment = DataUtils.ConvertValue<int?>(row["Experiment"]);
            this._OnComputer = DataUtils.ConvertValue<int?>(row["OnComputer"]);
            this._Other = DataUtils.ConvertValue<decimal?>(row["Other"]);
            this._Examsort = DataUtils.ConvertValue<string>(row["Examsort"]);
            this._Memo = DataUtils.ConvertValue<string>(row["Memo"]);
            this._ClassNum = DataUtils.ConvertValue<short?>(row["ClassNum"]);
            this._CLevel = DataUtils.ConvertValue<int?>(row["CLevel"]);
            this._MMedia = DataUtils.ConvertValue<string>(row["MMedia"]);
            this._RoomSort = DataUtils.ConvertValue<string>(row["RoomSort"]);
            this._SelectMode = DataUtils.ConvertValue<string>(row["SelectMode"]);
            this._NormalScale = DataUtils.ConvertValue<int?>(row["NormalScale"]);
            this._ExpScale = DataUtils.ConvertValue<int?>(row["ExpScale"]);
            this._ExamineScale = DataUtils.ConvertValue<int?>(row["ExamineScale"]);
            this._StuNum = DataUtils.ConvertValue<int?>(row["StuNum"]);
            this._UseDControl = DataUtils.ConvertValue<string>(row["UseDControl"]);
            this._RsGroup = DataUtils.ConvertValue<string>(row["RsGroup"]);
            this._IFPK = DataUtils.ConvertValue<string>(row["IFPK"]);
            ...
            this._ModifyOper = DataUtils.ConvertValue<string>(row["ModifyOper"]);
            this._ModifyDate = DataUtils.ConvertValue<DateTime?>(row["ModifyDate"]);
            this._NewOper = DataUtils.ConvertValue<string>(row["NewOper"]);
            this._NewDate = DataUtils.ConvertValue<DateTime?>(row["NewDate"]);
            this._EachSection = DataUtils.ConvertValue<string>(row["EachSection"]);
            this._OutLinenum = DataUtils.ConvertValue<int?>(row["OutLinenum"]);
        }
        #endregion
